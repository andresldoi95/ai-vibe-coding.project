              ...
              <div class="mt-3 overflow-hidden rounded-xl border border-teal-200/60 bg-gradient-to-br from-teal-50 to-cyan-50/50 shadow-sm dark:border-teal-900/30 dark:from-teal-950/20 dark:to-cyan-950/10">
                ...
                <div class="space-y-2 p-4">
                  <p class="mb-3 text-xs text-slate-600 dark:text-slate-400">
                    All passwords are: <code class="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-slate-700 dark:bg-slate-800 dark:text-slate-300">password</code>
                  </p>

                  <!-- Demo User Cards -->
                  <div class="space-y-2">
                    <!-- Owner -->
                    <div class="group flex items-center justify-between rounded-lg bg-white/80 px-3 py-2 shadow-sm ring-1 ring-slate-200/50 transition-all hover:shadow dark:bg-slate-900/40 dark:ring-slate-700/50">
                      <div class="flex items-center gap-2">
                        <i class="pi pi-crown text-amber-600 dark:text-amber-400" />
                        <code class="text-xs font-mono text-slate-700 dark:text-slate-300">owner@demo.com</code>
                      </div>
                      <Button
                        icon="pi pi-copy"
                        text
                        ...
                        @click="copyToClipboard('owner@demo.com')"
                      />
                    </div>
                    ...
                    <div class="group flex items-center justify-between rounded-lg bg-white/80 px-3 py-2 shadow-sm ring-1 ring-slate-200/50 transition-all hover:shadow dark:bg-slate-900/40 dark:ring-slate-700/50">
                      <div class="flex items-center gap-2">
                        <i class="pi pi-shield text-blue-600 dark:text-blue-400" />
                        <code class="text-xs font-mono text-slate-700 dark:text-slate-300">admin@demo.com</code>
                      </div>
                      <Button
                        icon="pi pi-copy"
                        text
                        ...
                        severity="secondary"
                        class="!h-6 !w-6 opacity-0 transition-opacity group-hover:opacity-100"
                        @click="copyToClipboard('admin@demo.com')"
                      />
                    </div>
                    ...
                    <div class="group flex items-center justify-between rounded-lg bg-white/80 px-3 py-2 shadow-sm ring-1 ring-slate-200/50 transition-all hover:shadow dark:bg-slate-900/40 dark:ring-slate-700/50">
                      <div class="flex items-center gap-2">
                        <i class="pi pi-briefcase text-teal-600 dark:text-teal-400" />
                        <code class="text-xs font-mono text-slate-700 dark:text-slate-300">manager@demo.com</code>
                      </div>
                      <Button
                        icon="pi pi-copy"
                        text
                        ...
                        severity="secondary"
                        class="!h-6 !w-6 opacity-0 transition-opacity group-hover:opacity-100"
                        @click="copyToClipboard('manager@demo.com')"
                      />
                    </div>
                    ...
                    <div class="group flex items-center justify-between rounded-lg bg-white/80 px-3 py-2 shadow-sm ring-1 ring-slate-200/50 transition-all hover:shadow dark:bg-slate-900/40 dark:ring-slate-700/50">
                      <div class="flex items-center gap-2">
                        <i class="pi pi-user text-slate-600 dark:text-slate-400" />
                        <code class="text-xs font-mono text-slate-700 dark:text-slate-300">user@demo.com</code>
                      </div>
                      <Button
                        icon="pi pi-copy"
                        text
                        ...
                        severity="secondary"
                        class="!h-6 !w-6 opacity-0 transition-opacity group-hover:opacity-100"
                        @click="copyToClipboard('user@demo.com')"
                      />
                    </div>
                  </div>
                </div>
