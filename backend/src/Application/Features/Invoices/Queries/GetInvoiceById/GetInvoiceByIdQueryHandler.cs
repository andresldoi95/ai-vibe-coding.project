    ...
    public async Task<Result<InvoiceDto>> Handle(GetInvoiceByIdQuery request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            var invoiceDto = new InvoiceDto
            {
                ...
                EmissionPointCode = invoice.EmissionPoint?.EmissionPointCode,
                EmissionPointName = invoice.EmissionPoint?.Name,
                EstablishmentCode = invoice.EmissionPoint?.Establishment?.EstablishmentCode,
                ...
                SignedXmlFilePath = invoice.SignedXmlFilePath,
                RideFilePath = invoice.RideFilePath,
