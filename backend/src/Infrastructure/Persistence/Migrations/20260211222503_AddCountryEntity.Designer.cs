...
namespace SaaS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260211222503_AddCountryEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaaS.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<Guid?>("BillingCountryId1")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ShippingCountryId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BillingCountryId1");

                    b.HasIndex("IsActive");

                    b.HasIndex("ShippingCountryId");

                    b.HasIndex("ShippingCountryId1");
            ...
            modelBuilder.Entity("SaaS.Domain.Entities.Customer", b =>
                {
                    b.HasOne("SaaS.Domain.Entities.Country", null)
                        .WithMany()
                    ...
                    b.HasOne("SaaS.Domain.Entities.Country", "BillingCountry")
                        .WithMany()
                        .HasForeignKey("BillingCountryId1");
                    ...
                    b.HasOne("SaaS.Domain.Entities.Country", "ShippingCountry")
                        .WithMany()
                        .HasForeignKey("ShippingCountryId1");
