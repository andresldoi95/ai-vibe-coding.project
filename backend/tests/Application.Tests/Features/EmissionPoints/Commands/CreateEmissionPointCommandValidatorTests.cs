...
public class CreateEmissionPointCommandValidatorTests
{
    private readonly CreateEmissionPointCommandValidator _validator;

    public CreateEmissionPointCommandValidatorTests()
    {
        _validator = new CreateEmissionPointCommandValidator();
    }
